...
export interface AccessTokenResponse {
    /**
     * Unique UUIDv7 identifier of the access token
     * @type {string}
     * @memberof AccessTokenResponse
     */
    id?: string;
    /**
     * Friendly human-readable label identifying the access token
     * @type {string}
     * @memberof AccessTokenResponse
     */
    name?: string;
    ...
    created_at?: Date;
    /**
     * Timestamp when this token was last used to authenticate an API request
     * @type {Date}
     * @memberof AccessTokenResponse
     */
