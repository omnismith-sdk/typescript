...
> FileAttachmentResponse getFileAttachmentMetadata(id, xOmnismithProjectId)
...
> FileAttachmentResponse uploadFileAttachment(file, xOmnismithProjectId, id, context, ttlHours)
