...
```typescript
import type { UpdateDashboardBlockRequestConfig } from '@omnismith-sdk/typescript'
...
const example = {
  ...
  "cols": 6,
  "rows": 3,
} satisfies UpdateDashboardBlockRequestConfig
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateDashboardBlockRequestConfig
