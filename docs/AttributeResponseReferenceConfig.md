...
```typescript
import type { AttributeResponseReferenceConfig } from '@omnismith/sdk-typescript'
...
const exampleParsed = JSON.parse(exampleJSON) as AttributeResponseReferenceConfig
