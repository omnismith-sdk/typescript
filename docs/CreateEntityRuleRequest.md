...
```typescript
import type { CreateEntityRuleRequest } from '@omnismith-sdk/typescript'
...
const example = {
  ...
  "when": null,
  "then": null,
} satisfies CreateEntityRuleRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CreateEntityRuleRequest
