...
```typescript
import type { MarketplaceBlueprintSummaryResponse } from '@omnismith-sdk/typescript'
...
} satisfies MarketplaceBlueprintSummaryResponse
...
const exampleParsed = JSON.parse(exampleJSON) as MarketplaceBlueprintSummaryResponse
